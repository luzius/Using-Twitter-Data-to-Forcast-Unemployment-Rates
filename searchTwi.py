...
__author__ = 'original: Tom Dickinson; changes by: Luzius von Gunten'
    ...
    def parse_tweets(items_html):
        ...
        for li in soup.find_all("li", class_='js-stream-item'):
            ...
            if date_span is not None:
                tweet['created_at'] = datetime.datetime.fromtimestamp((float(date_span['data-time-ms'])/1000)).strftime("%Y-%m-%d")
